import { StyleSheet, Text, View, useColorScheme, Image, TextInput, SafeAreaView, TouchableOpacity } from 'react-native';
        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.main}>
                ...
                <View style={[styles.loginView]}>
                    <Text style={[styles.loginHeading, styles.whiteText]}>Doctor Login</Text>
                </View>
                <View>
